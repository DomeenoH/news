...
def draw_text(draw):
    ...
    draw.text((220,200),verse(),font=font_sentence)
    draw.text((800,300), "来点每日新闻！",font=font_sentence)
    draw.text((650,330), "更新于", font=font_sentence)
    draw.text((730,330), strftime("%Y-%m-%d %H:%M:%S", localtime(time())), font=font_sentence)
